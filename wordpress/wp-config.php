 ...
 * @since 2.6.0
 */
define('AUTH_KEY',         '!h6*NQf_%1eMT{C{n-(<+HG*:8$=A`XOrSC6g]!Q+K>bQ#V>L4>Okm5TZ=`c:C(`');
define('SECURE_AUTH_KEY',  ';i`-F@U@KP l&sEg5d7.?+9-`Di3=SCeX ^mh(}to-:&xtGrtb56XUg+K0#YR+>3');
define('LOGGED_IN_KEY',    'VbD1}p6I0-L-i~w!/XE{ZTQZly*GUP2x~^:W#=qmN.),=2ub5+[o`)[mY:)X#uxf');
define('NONCE_KEY',        'Zd$!.? ;q<x1}Fj0@C02xzDpE+4>W[wz4*J+B3(3XX-h4V74bQ7(=Qi&C>N Z=<Y');
define('AUTH_SALT',        '#PDFyyl>/5^{Z^p63]`/:?48]=D<Voik4WDE0L*f]%9uphZVAPa>4~DC-TlPi(rL');
define('SECURE_AUTH_SALT', '~!fOjGv[Eu!,00=*Sgc@nU`:t[&z#0t[2TA`,kM~c %&:;{X9vU8 HdIXS6G|A+A');
define('LOGGED_IN_SALT',   '<n/khhzD{Te7R~r*u6&>{s(a.[yC-2Ovy(sV{FeNZbn.->>fLIs<4zC;@nN>#v:z');
define('NONCE_SALT',       'pNUM!;iW5QZaE.<bj #-Z(44^W?Hp,CmB _X_g]z+Y_${@.k/vHIE:`Cv*uF@pH2');
